    ...
    <main>
      ...
      <div className="mx-auto">
        ...
        <div className='bg-gray-800 shadow-2xl max-w-screen-xl font-sans md:mx-auto'>
            ...
            <Image className='mx-10 my-20 h-48 border border-black' src='/image/profile_pic.jpg' alt="profile picture" width={140} height={130}></Image>
              <span className="text-2xl font-semibold mb-2">Lim Tau Jun</span>
              <span className={style.nav_bar_text}><a href='#about'>About</a></span>
              <span className={style.nav_bar_text}><a href='#education'>Education</a></span>
              <span className={style.nav_bar_text}><a href='#skills'>Skills</a></span>
              <span className={style.nav_bar_text}><a href='#experience'>Experience</a></span>
